...
export default function PromoSection() {
  return (
    <section className="py-16 bg-white" aria-label="Promotion">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-gray-100 border border-gray-300">
          {/* Background pattern */}
          ...
          <div className="relative grid md:grid-cols-2 gap-0">
            ...
            <div className="p-10 md:p-14 flex flex-col justify-center">
              ...
              <h2 className="font-display text-4xl md:text-5xl text-gray-900 tracking-wider leading-none mb-4">
                SAVE UP TO{" "}
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Link
                  to="/shop"
                  className="fire-gradient text-gray-900 font-bold px-8 py-4 rounded-xl text-sm uppercase tracking-wider hover:opacity-90 transition-opacity text-center fire-glow"
                >
                  Shop the Sale
                </Link>
                <Link
                  to="/shop?category=Pellet+Grill"
                  className="border border-gray-400 hover:border-fire-600 text-gray-600 hover:text-gray-900 font-semibold px-8 py-4 rounded-xl text-sm uppercase tracking-wider transition-all text-center"
                >
                  View Pellet Grills
                </Link>
              </div>
            ...
            <div className="relative hidden md:block">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-r from-gray-800/80 to-transparent rounded-r-3xl" />
              {/* Price badge */}
              <div className="absolute top-8 right-8 bg-fire-600 text-gray-900 rounded-2xl p-4 text-center shadow-xl fire-glow">
