    ...
    <div className="min-h-screen bg-gray-50 text-gray-700">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          <section>
            <h2 className="font-display text-2xl text-gray-900 tracking-wider mb-4">1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl text-gray-900 tracking-wider mb-4">2. Information We Collect</h2>
            <h3 className="text-xl text-gray-900 font-semibold mb-2">Personal Information</h3>
            ...
            <h3 className="text-xl text-gray-900 font-semibold mb-2 mt-4">Automatically Collected Information</h3>
            <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            <h2 className="font-display text-2xl text-gray-900 tracking-wider mb-4">3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="font-display text-2xl text-gray-900 tracking-wider mb-4">4. Information Sharing</h2>
          ...
          <section>
            <h2 className="font-display text-2xl text-gray-900 tracking-wider mb-4">5. Cookies and Tracking</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl text-gray-900 tracking-wider mb-4">6. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl text-gray-900 tracking-wider mb-4">7. Your Rights</h2>
          ...
          <section>
            <h2 className="font-display text-2xl text-gray-900 tracking-wider mb-4">8. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl text-gray-900 tracking-wider mb-4">9. Children's Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl text-gray-900 tracking-wider mb-4">10. International Users</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl text-gray-900 tracking-wider mb-4">11. Changes to This Policy</h2>
            <p>
