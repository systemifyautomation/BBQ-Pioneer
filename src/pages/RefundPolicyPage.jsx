    ...
    <div className="min-h-screen bg-coal-950 text-coal-200">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-invert prose-coal max-w-none space-y-8">
          <section>
            <h2 className="font-display text-2xl text-white tracking-wider mb-4">1. Our Satisfaction Guarantee</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl text-white tracking-wider mb-4">2. Return Eligibility</h2>
          ...
          <section>
            <h2 className="font-display text-2xl text-white tracking-wider mb-4">3. How to Initiate a Return</h2>
          ...
          <section>
            <h2 className="font-display text-2xl text-white tracking-wider mb-4">4. Return Shipping Costs</h2>
            <h3 className="text-xl text-white font-semibold mb-2">Standard Returns</h3>
            <p>
            ...
            <h3 className="text-xl text-white font-semibold mb-2 mt-4">Defective or Damaged Items</h3>
            <p>
            ...
            <h3 className="text-xl text-white font-semibold mb-2 mt-4">Wrong Item Shipped</h3>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl text-white tracking-wider mb-4">5. Restocking Fee</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl text-white tracking-wider mb-4">6. Refund Processing</h2>
          ...
          <section>
            <h2 className="font-display text-2xl text-white tracking-wider mb-4">7. Exchanges</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl text-white tracking-wider mb-4">8. Defective Products</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl text-white tracking-wider mb-4">9. Warranty Support</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl text-white tracking-wider mb-4">10. Non-Returnable Items</h2>
          ...
          <section>
            <h2 className="font-display text-2xl text-white tracking-wider mb-4">11. Cancellations</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl text-white tracking-wider mb-4">12. Late or Missing Refunds</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl text-white tracking-wider mb-4">13. Contact Us</h2>
            <p>For return and refund questions, contact:</p>
            <div className="mt-4 p-4 bg-coal-800 rounded-lg">
              <p className="font-semibold text-white">{contactInfo.businessName} Returns Department</p>
